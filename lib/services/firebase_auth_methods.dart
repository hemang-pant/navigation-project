...
import 'package:dtuNavigation/models/user_model.dart';
import 'package:dtuNavigation/utils/showOTPDialog.dart';
...
class FirebaseAuthMethods {
  ...
  // https://firebase.flutter.dev/docs/auth/start#auth-state
    ...
    try {
      await _auth.signOut().then((value) => Navigator.of(context)
          .pushNamedAndRemoveUntil(
              '/first_screen', (Route<dynamic> route) => false));
    } on FirebaseAuthException catch (e) {
      showSnackBar(context, e.message!); // Displaying the error message
    }
  }
